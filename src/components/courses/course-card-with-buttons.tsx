  ...
  return (
    ...
    >
      ...
      <div className={'v-stack justify-between w-full py-4 gap-2'}>
        ...
        <div
          className={
            'w-full flex gap-2 items-center sm:justify-between'
          }
        >
          {!purchased && (
            <Button
          ...
          {!purchased && (
            <Button
              className={cn(
                'bg-brand-yellow-primary text-xs md:text-sm text-primary hover:bg-brand-yellow-accent w-full',
                {
                  'bg-[#D3D5D6]': isAdded,
                }
              )}
          ...
          {purchased && (
            <Button
              className={
                'bg-[#D3D5D6] text-[#70787C] hover:bg-gray-300'
              }
            >
              Purchased
            </Button>
