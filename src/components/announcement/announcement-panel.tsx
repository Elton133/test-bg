...
const AnnouncementPanel = ({
  ...
  return (
    <div
      className="fixed bg-white top-[56px] md:top-[88px] shadow-md rounded-lg right-2 h-auto max-w-[280px] md:max-w-[400px] w-full z-30 animate-fade-down animate-duration-200 md:max-h-[400px] max-h-[250px] overflow-scroll"
      ref={ref}
    >
