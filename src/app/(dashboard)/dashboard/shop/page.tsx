        ...
        >
          <div className={"flex flex-col gap-6 md:gap-y-12"}>
            <div className={"flex flex-col gap-2"}>
              <h1
                className={"text-brand-yellow-primary text-[40px] font-black"}
              >
                BSG SHOP
              </h1>
              <p className={"text-brand-yellow-accent font-medium text-base"}>
                Buy our courses now and access expertly crafted content tailored
                to ensure your success in the bar exam.
              </p>
            </div>
            <div className={"flex flex-col gap-4"}>
              <p className={"text-brand-yellow-primary"}>Here are our rates</p>
              <div
                className={
