      ...
      <div className={'mb-8'}>
        ...
        <div className={'v-stack py-6'}>
          ...
          <p className={'text-sm'}>
            ...
            replace any part of these Terms at any time. You can always
            access these Terms here, to review any changes. Please note
            that your continued use of our Services constitute an
            acceptance of any updates, changes or replacements made to
            these Terms.
          </p>
          <p className={'text-sm'}>
            These Terms apply to all BSG website users including content
            contributors, customers, and/or browsers. Therefore, please
            carefully review these Terms and our Privacy Policy. If
            after your review, you do not agree to these Terms and our
            Privacy Policy, do not access and/or use our Services.
          </p>
        </div>
      </div>
      <ol className={'list-decimal list-inside'}>
        <li className="mb-8 font-bold text-base">
          ...
          <ul className="list-disc list-inside px-4 text-sm my-4">
            {termsAndConditions.definitions.map((definition, index) => (
