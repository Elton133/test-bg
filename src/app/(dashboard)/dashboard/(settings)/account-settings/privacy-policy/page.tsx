...
export default function PrivacyPolicyPage() {
  return (
    <main
      className={
        'md:pb-8 max-h-[80vh] overflow-y-scroll no-scrollbar mx-auto'
      }
    >
      <section className={'max-w-7xl w-full mx-auto v-stack gap-12'}>
        ...
        <div className={'v-stack gap-6 px-2'}>
          ...
          <div className={'px-2 md:px-4 v-stack text-sm'}>
            <p>
        ...
        {/* Contribution */}
        <div className={'v-stack gap-6 px-2'}>
          <h1 className={'text-xl font-semibold'}>Your contribution</h1>
        ...
        <div className={'v-stack gap-6 px-2'}>
          ...
          <div className={'v-stack px-2 md:px-4 text-sm'}>
            <p>
        ...
        <div className={'v-stack gap-6 px-2'}>
          ...
          <div className={'v-stack px-2 md:px-4 gap-4 text-sm'}>
